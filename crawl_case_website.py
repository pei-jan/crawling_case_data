...
st.title('招標網團險案件查詢')
st.markdown(f'<p><span style = "font-size:20px"><strong>即時搜尋政府招標網，篩選團險案件</strong></span></p>',unsafe_allow_html=True)
...
關鍵字2_4 = st.text_input("篩選關鍵字(4)",value='鎮民')
關鍵字2_5 = st.text_input("篩選關鍵字(5)",value='市民')
關鍵字2_6 = st.text_input("篩選關鍵字(6)",value='義勇')
關鍵字2_7 = st.text_input("篩選關鍵字(7)",value='義消')
關鍵字2_8 = st.text_input("篩選關鍵字(8)",value='志工')
關鍵字2_9 = st.text_input("篩選關鍵字(9)",value='守望相助')
st.markdown(f'<p><span style = "font-size:20px"><strong>篩選關鍵字不含條件，具其一則不顯示，可自行修改</strong></span></p>',unsafe_allow_html=True)
關鍵字2_10 = st.text_input("篩選關鍵字不含(1)",value='開口合約')
關鍵字2_11 = st.text_input("篩選關鍵字不含(2)",value='責任')
